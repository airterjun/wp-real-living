...
add_action('enqueue_block_assets', function () {
    ...
    wp_enqueue_style('custmom-b-admin-style', get_template_directory_uri() . '/dist/block.css', array(), '1.1001.000');
    wp_enqueue_style('custmom-b-style', get_template_directory_uri() . '/dist/style-block.css', array(), '1.1001.000');
});
