...
const MediaInput = (props) => {
    ...
    const renderMedia = () => {
        if (type === 'video') {
            ...
            return <img src={getValue ? getValue.replace("-scaled", "") : ""} width={width} height={height} />
        }
    }
    ...
    if (edit) {
        ...
        return (
            ...
            <figure className={`${className} edit media-editor`}>
