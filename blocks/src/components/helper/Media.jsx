...
export default function Media(props) {
    ...
    const renderMedia = () => {
        if (type === 'video') {
            ...
            return <img src={getValue} width={width} height={height} alt="We Are Real" loading="lazy" decoding="async" />
        }
    }
