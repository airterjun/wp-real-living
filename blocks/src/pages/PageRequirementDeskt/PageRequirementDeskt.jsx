...
import RegularBanner, {
  attributes as RegularBannerAttr,
} from "../../components/RegularBanner";
import RegularBannerHalfText, {
  attributes as RegularBannerHalfTextAttr,
} from "../../components/RegularBannerHalfText";
import { ObjectSchema } from "../../components/Schema/object";
import TwoColumnText, {
  attributes as TwoColumnTextAttr,
} from "../../components/TwoColumnText";
import TwoGridColumnCard, {
  attributes as TwoGridColumnCardAttr,
} from "../../components/TwoGridColumnCard";
...
export const pageAttr = {
  ...
  data: {
    ...
    section_7: ObjectSchema(BannerContactAttr),
    bannerinvesting: ObjectSchema(RegularBannerHalfTextAttr),
  },
};
...
export default function (props) {
  return (
    <div className="requirement">
      ...
      <RegularBannerHalfText {...props} model="bannerinvesting" />
      <FeaturedTitle
        {...props}
        model="section_4"
        section="4"
      ...
      <BannerContact
        ...
        hideBanner={true}
      />
      <BannerContact {...props} model="section_7" section="6" />
    </div>
  );
}
