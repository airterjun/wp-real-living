...
const Program = () => {
  ...
  for (let i = 0; i <= 2; i++) {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(figure, {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(figure, {
      marginTop: 0,
      marginLeft: 0,
      x: 0,
      y: 0,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(headerTitle, {
    width: 0,
    scrollTrigger: {
      trigger: headerTitle,
      start: "top 80%",
  ...
  parallax() {
    ...
    if (images) {
      images.forEach(p => {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(image, {
          yPercent: 25,
          scrollTrigger: {
            scrub: 1,
            trigger: p,
