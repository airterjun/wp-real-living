    ...
    <div class="inner">
        <div class="footer__logo">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 326 75">
                <g fill="#474849" clip-path="url(#aadadadadasd)">
                    <path
        ...
        <div class="locations">
            <div class="locations__item">
                ...
                <div class="wrap">
                    <div class="address">
                        Jl. Pemelisan Agung<br />Berawa - Bali<br />Tel. 0817-7413-4586<br />11.30-24.00
                    </div>
                    <?php venue_menu('footer-bistro') ?>
                </div>
            </div>
            ...
            <div class="locations__item">
                ...
                <div class="wrap">
                    <div class="address">
                        Jl. Pantai Pererenan<br />Pererenan - Bali<br />Tel. 0822-9599-7800<br />12.00-24.00
                    </div>
                    <?php venue_menu('footer-trattoria') ?>
                </div>
            </div>
            ...
            <div class="locations__item">
                ...
                <div class="wrap">
                    <div class="address">
                        Jl. Pratu Rai Madra<br />Cemagi - Bali<br />Tel. 0823-4067-0942<br />8.00-23.00
                    </div>
                    <?php venue_menu('footer-cafe') ?>
                </div>
            </div>
        ...
        <div class="locations office-menu">
            <div class="locations__item">
                <h3 class="office-heading">
                    Group Office
                </h3>
                <div class="wrap">
                    <div class="address">
                        <strong>PT Riviera Hospitality Group</strong>
                        Gg. Rajawali II No.08-20 Blok A<br />Berawa - Bali<br />Tel. 0895-1322-7167<br />9.00-18.00
                    </div>
                </div>
            </div>
...
<div class="footer-copy grid">
    <div class="inner">
        <div class="copy-text">© Riviera Group, <?php echo date("Y") ?></div>
        <div class="website-by">
            Branding and design by <a href="https://balibranding.com" class="underline-link" target="_blank">Bali
                Branding</a>
        </div>
    </div>
</div>
...
<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/dist/style-nolsis.css' ?>" />

<style>
    .page-private-event .normal-hero-banner {
        height: 49vh;
    }
